...
async def create_topic_and_start_dialog(query, context, user, topic_name, dialog_type):
    ...
    try:
        ...
        await query.edit_message_caption(
            caption=f"Отлично! Тема для {dialog_type} создана. Напишите ваше сообщение, и наш специалист ответит вам."
        )
        ...
        await query.edit_message_caption(
            caption="Произошла ошибка. Пожалуйста, попробуйте позже или свяжитесь с нами напрямую."
        )
